...
class ProductSizeController extends Controller
{
    ...
    {
        return view('admin.store.sizes.index');
    }
    ...
    {
        return view('admin.store.sizes.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $termExtraData = Validator::validate($request->all(), (new TermExtra())->sizeRules());

        $term = Term::create($termData + ['type' => config('term-types.product_size')]);
    ...
    public function edit($id)
    {
        ...
        return view('admin.store.sizes.edit', compact('term'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $termExtraData = collect(Validator::validate($request->all(), (new TermExtra())->sizeRules()));
