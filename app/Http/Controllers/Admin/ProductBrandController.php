...
class ProductBrandController extends Controller
{
    ...
    {
        return view('admin.store.brands.index');
    }
    ...
    {
        return view('admin.store.brands.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $termExtraData = Validator::validate($request->all(), (new TermExtra())->brandRules());

        $term = Term::create($termData + ['type' => config('term-types.product_brand')]);
    ...
    public function edit($id)
    {
        ...
        return view('admin.store.brands.edit', compact('term'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $termExtraData = collect(Validator::validate($request->all(), (new TermExtra())->brandRules()));
