...
class ProductAttributeController extends Controller
{
    ...
    {
        return view('admin.store.attributes.index');
    }
    ...
    {
        return view('admin.store.attributes.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $termExtraData = Validator::validate($request->all(), (new TermExtra())->attributeRules());

        $term = Term::create($termData + ['type' => config('term-types.product_attribute')]);
    ...
    public function edit($id)
    {
        ...
        return view('admin.store.attributes.edit', compact('term'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $termExtraData = collect(Validator::validate($request->all(), (new TermExtra())->attributeRules()));
