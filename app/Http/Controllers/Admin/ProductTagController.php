...
class ProductTagController extends Controller
{
    ...
    {
        return view('admin.store.tags.index');
    }
    ...
    {
        return view('admin.store.tags.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $termExtraData = Validator::validate($request->all(), (new TermExtra())->tagRules());

        $term = Term::create($termData + ['type' => config('term-types.product_tag')]);
    ...
    public function edit($id)
    {
        ...
        return view('admin.store.tags.edit', compact('term'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $termExtraData = collect(Validator::validate($request->all(), (new TermExtra())->tagRules()));
