...
@section('title')
    {{ trans('menu.all') . ' ' . trans('menu.colors') }}
@endsection

@section('page-title')
    {{ trans('menu.all') . ' ' . trans('menu.colors') }}
    <a href="{{ route('admin.product-colors.create') }}" class="btn btn-sm btn-outline-primary">{{ trans('menu.add') . ' ' . trans('menu.color') }}</a>
@endsection
...
@section('breadcrumb')
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">{{ trans('menu.colors') }}</li>
        </ol>
    </div>
@endsection

@section('page-content')
    @livewire('admin.store.color.index')
@endsection
