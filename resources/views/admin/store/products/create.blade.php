...
@section('title')
    {{ trans('form-actions.add') . ' ' . trans('menu.product') }}
@endsection
...
@section('breadcrumb')
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">{{ trans('form-actions.add') . ' ' . trans('menu.product') }}</li>
        </ol>
    </div>
@endsection

@section('page-content')
    @livewire('admin.store.product.form')
@endsection
