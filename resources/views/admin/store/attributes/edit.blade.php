...
@section('title')
    {{ trans('form-actions.update') . ' ' . trans('menu.attribute') }}
@endsection
...
@section('breadcrumb')
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">{{ trans('form-actions.update') . ' ' . trans('menu.attribute') }}</li>
        </ol>
    </div>
@endsection

@section('page-content')
    @livewire('admin.store.attribute.form', compact('term'))
@endsection
