<div>
    @if ($term)
    {!! Form::model($term, ['url' => route('admin.product-categories.update', $term->id), 'method' => 'PUT', 'files' => true, 'autocomplete' => 'off']) !!}
    @else
    {!! Form::open(['url' => route('admin.product-categories.store'), 'method' => 'post', 'files' => true, 'autocomplete' => 'off']) !!}
    @endif
        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 form-group" wire:ignore>
                                ...
                                {{ Form::select('parent_id',
                                    \App\Models\Term::productCategories()->active()->whereNotIn('id', [$term->id ?? 0])->orderBy('name')->pluck('name', 'id')->toArray(), null, [
