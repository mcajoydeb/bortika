<div>
    @if ($term)
    {!! Form::model($term, ['url' => route('admin.product-tags.update', $term->id), 'method' => 'PUT', 'files' => true, 'autocomplete' => 'off']) !!}
    @else
    {!! Form::open(['url' => route('admin.product-tags.store'), 'method' => 'post', 'files' => true, 'autocomplete' => 'off']) !!}
    @endif
        <div class="row">
                ...
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        <div class="col-12 form-group" wire:ignore>
                            ...
                            {{ Form::textarea('_description', null, ['class' => ($errors->has('_description') ? 'is-invalid' : '') . ' form-control', 'wire:model' => '_description']) }}
                            @error('_description')
                            <div class="text-danger">
                                {{ $message }}
                            </div>
