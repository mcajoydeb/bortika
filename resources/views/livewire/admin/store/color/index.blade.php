        ...
        <div class="col-12">
            <div class="card card-secondary">
                <div class="card-header">
                    <h3 class="card-title">{{ trans('menu.all') . ' ' . trans('menu.colors') }}</h3>
                    ...
                    <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $term->name }}</td>
                                <td>
                                    <span>{{ $term->getExtraValueByKey('_color_code') }}</span>
                                    <div style="background-color:{{ $term->getExtraValueByKey('_color_code') }};height:20px;width:60px"></div>
                                </td>
                                <td>{!! $term->statusLabel() !!}</td>
                                <td>
                                    <a class="btn btn-xs btn-warning mr-2"
                                        href="{{ route('admin.product-colors.edit', $term->id) }}"><i class="fa fa-edit"></i>
                                        {{ trans('form-actions.edit') }}</a>

                                    {!! Form::open(['url' => route('admin.product-colors.destroy', $term->id), 'method' =>
