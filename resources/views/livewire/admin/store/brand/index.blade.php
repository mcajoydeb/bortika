        ...
        <div class="col-12">
            <div class="card card-secondary">
                <div class="card-header">
                    <h3 class="card-title">{{ trans('menu.all') . ' ' . trans('menu.brands') }}</h3>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-xs btn-warning mr-2"
                                        href="{{ route('admin.product-brands.edit', $term->id) }}"><i class="fa fa-edit"></i>
                                        {{ trans('form-actions.edit') }}</a>

                                    {!! Form::open(['url' => route('admin.product-brands.destroy', $term->id), 'method' =>
