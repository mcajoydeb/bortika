        ...
        <div class="col-12">
            <div class="card card-secondary">
                <div class="card-header">
                    <h3 class="card-title">{{ trans('menu.all') . ' ' . trans('menu.attributes') }}</h3>
                    ...
                    <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $term->name }}</td>
                                <td>{{ $term->getExtraValueByKey('_attribute_values') }}</td>
                                <td>{!! $term->statusLabel() !!}</td>
                                <td>
                                    <a class="btn btn-xs btn-warning mr-2"
                                        href="{{ route('admin.product-attributes.edit', $term->id) }}"><i class="fa fa-edit"></i>
                                        {{ trans('form-actions.edit') }}</a>

                                    {!! Form::open(['url' => route('admin.product-attributes.destroy', $term->id), 'method' =>
