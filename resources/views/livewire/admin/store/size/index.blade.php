        ...
        <div class="col-12">
            <div class="card card-secondary">
                <div class="card-header">
                    <h3 class="card-title">{{ trans('menu.all') . ' ' . trans('menu.sizes') }}</h3>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-xs btn-warning mr-2"
                                        href="{{ route('admin.product-sizes.edit', $term->id) }}"><i class="fa fa-edit"></i>
                                        {{ trans('form-actions.edit') }}</a>

                                    {!! Form::open(['url' => route('admin.product-sizes.destroy', $term->id), 'method' =>
